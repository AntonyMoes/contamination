...
namespace _Game.Scripts.BurnMark.UI {
    public class LobbyClientInterface : MonoBehaviour {
        ...
        private void SetCurrentState() {
            ...
            _disconnectedContent.SetActive(state == LobbyClient<RoomSettings>.EState.NotConnected);
            _connectedContent.SetActive(state != LobbyClient<RoomSettings>.EState.NotConnected);
            _createRoomContent.SetActive(state == LobbyClient<RoomSettings>.EState.Connected);
        }
        ...
        void ReloadContent() {
            ...
            foreach (var roomData in lobbyData.Rooms) {
                ...
                room.SetData(roomData, currenUser, TryJoinRoom, TryLeaveRoom, TryStartGame);
                _rooms.Add(room);
            }
        }
